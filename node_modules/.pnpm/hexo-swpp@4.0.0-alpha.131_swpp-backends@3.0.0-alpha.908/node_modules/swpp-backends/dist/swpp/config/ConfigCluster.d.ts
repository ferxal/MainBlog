...
import { ContextConfig, IndivisibleConfig, LazyInitConfig, NoCacheConfig, RuntimeSpecialConfig, RuntimeSupplier, SpecialConfig } from './SpecialConfig';
/**
 ...
 * 定义一个区分开发环境和生产环境的配置项。
 */
export declare function defineContextConfig<T>(config: {
    dev: SwppConfigValueExp<T>;
    prod: SwppConfigValueExp<T>;
}): ContextConfig<T>;
/**
 * 定义一个不会被缓存的配置项。
 *
