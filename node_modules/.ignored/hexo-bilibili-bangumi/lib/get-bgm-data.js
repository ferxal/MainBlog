...
var getBangumiDataFromBangumiApi = /*#__PURE__*/function () {
  ...
  return function getBangumiDataFromBangumiApi(_x7, _x8, _x9, _x0) {
      ...
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 19:
          ...
          if (showProgress) {
            ...
            bar = new ProgressBar("\u6B63\u5728\u83B7\u53D6 ".concat(status === 'wish' ? '[想看]' : status === 'do' ? '[在看]' : '[已看]', " ").concat(type === 'game' ? '游戏' : type === 'real' ? '追剧' : '番剧', " [:bar] :percent :elapseds"), {
